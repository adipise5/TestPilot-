...
export const api = {
  ...
  getCodeReviewPlan: (projectId) => apiRequest(`/projects/${projectId}/code-reviews/plan`),
  getCodeReviews: (projectId) => apiRequest(`/projects/${projectId}/code-reviews`),
  startCodeReview: (projectId, snapshotId, batchOffset = 0) => apiRequest(`/projects/${projectId}/code-reviews`, 'POST', { snapshotId, batchOffset }),
  getCodeReview: (projectId, reviewId, download = false) => apiRequest(`/projects/${projectId}/code-reviews/${reviewId}${download ? '/download' : ''}`),
